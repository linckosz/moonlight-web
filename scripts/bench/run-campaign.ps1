...
Write-Host "  7. kiosk-close.ps1                                      (take the kiosks off the screen)"
Write-Host ""
Write-Host "The kiosks are borderless, TOPMOST and have no close button. The way out, at any"
Write-Host "moment and whatever else has the focus: Ctrl+Alt+Shift+M minimises them,"
Write-Host "Ctrl+Alt+Shift+Q closes them. run-browser.ps1 also closes them on its way out."
Write-Host ""
