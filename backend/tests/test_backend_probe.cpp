...
// Captured live from the bench-desk Sunshine host, 2026-08-24, unpaired.
const char* const kSunshineServerInfo =
    "<?xml version=\"1.0\" encoding=\"utf-8\"?>"
    "<root status_code=\"200\"><hostname>bench-desk</hostname>"
...
void run_backend_probe_tests()
{
    ...
    // (bench-desk and the bench-mini, 2026-08-26): the management API answers a
    ...
    CHECK_EQ(BackendProbe::sunshineRestPort(51989), 51990);
