...
L'hote "780M" (adresse 10.0.0.9:47989) reste marque `state: "offline"` dans MWServer alors que Moonlight-QT le voit immediatement online.
...
3. **Analyse le flux de detection** :
   ...
   - Pourquoi un host avec un localAddress valide (10.0.0.9:47989) pourrait rester offline
