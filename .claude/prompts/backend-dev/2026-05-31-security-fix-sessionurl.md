...
Contexte : La reponse de `/start` ou `/launch` contient un champ `sessionUrl` du type `rtspenc://10.0.0.9:48010` qui expose l'IP interne du reseau (entre le serveur MW et Sunshine) au navigateur client. Cela ne devrait jamais etre visible par le frontend.
