...
Tache : Securite — le log `Launch result` dans la console navigateur expose l'IP interne du reseau (ex: `sessionUrl: 'rtspenc://10.0.0.9:48010'`).

Contexte : Un utilisateur a vu dans la console JS du navigateur le message suivant :
```
Launch result: { gamingMode: true, sessionUrl: 'rtspenc://10.0.0.9:48010', ... }
```
